...
const DADOS = {
  ...
  _agendaTarefasSeed: [
    ...
    { status:"andamento", titulo:"Levar o VW Voyage (V06) para a revisão de suspensão",                resp:"Victor Paiva" },
    { status:"concluida", titulo:"Renovar o seguro do Nissan Versa (V08)",                             resp:"Victor Paiva" }
  ],
